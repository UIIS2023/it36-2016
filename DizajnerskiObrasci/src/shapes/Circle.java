...
public class Circle extends SurfaceShape {
	...
	//private Color bojaUnut; old code
	...
	public Circle(Point center, int radius, Color insideColor, Color outsideColor) {
		...
		//this.insideColor = insideColor; zamenjeno kad sam izmestio da nasledjuje surfaceshape
...
//	}
	...
	public Circle clone(Circle c) {
		...
		c.setPositionHistory(this.getPositionHistory());
		return c;
	}
